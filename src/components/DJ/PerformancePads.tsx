...
const PerformancePads = ({ side }: PerformancePadsProps) => {
  ...
  return (
    <div className="bg-gray-900/50 rounded-lg p-3 border border-purple-500/20">
      <div className="text-xs text-purple-400 font-semibold mb-3 text-center">CUE PADS</div>
      <div className="grid grid-cols-2 gap-2">
        {pads.map((pad) => (
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-12 h-12 bg-gray-800 border-2 border-purple-500/30 hover:border-purple-500 hover:bg-purple-600/20 transition-all flex items-center justify-center text-purple-400 hover:text-white rounded-lg shadow-lg"
          >
