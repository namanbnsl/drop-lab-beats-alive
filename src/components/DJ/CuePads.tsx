    ...
    <div className="grid grid-cols-2 gap-3">
      {pads.map((pad) => (
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="w-12 h-12 bg-gray-800 rounded-full border-2 border-purple-500/30 hover:border-purple-500 transition-all flex items-center justify-center text-purple-400 hover:text-white hover:bg-purple-600/20"
        >
