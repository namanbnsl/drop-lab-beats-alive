  ...
  return (
    <>
      ...
      >
        ...
        {/* Upload Section */}
        <div className="mb-6">
          <label className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-blue-500/30 rounded-lg cursor-pointer hover:border-blue-500 transition-colors">
        ...
        <div className="mb-6 space-y-3">
          <div className="text-sm text-blue-400 font-semibold">Google Drive Link</div>
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 bg-gray-800 border border-blue-500/30 rounded text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none"
            />
            <button
        ...
        <div className="space-y-3">
          {tracks.map((track) => (
            <motion.div
              ...
              className="bg-black rounded-lg p-4 border border-blue-500/20"
            >
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 px-3 py-2 bg-blue-600/20 border border-blue-500/30 rounded text-blue-400 hover:bg-blue-600/30 transition-all text-sm"
                >
                  Load to A
                </button>
                <button
